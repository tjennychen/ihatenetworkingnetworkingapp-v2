...
// All SVGs use currentColor so they inherit text color

const s = (content: string, w = 16, h = 16, vb = '0 0 16 16') =>
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${vb}" fill="currentColor" width="${w}" height="${h}" style="display:inline-block;vertical-align:middle;flex-shrink:0">${content}</svg>`
